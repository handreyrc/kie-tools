...
public class BackingColorMapUtils {
    ...
    //handrey
    public static void drawShapesToBacking(NFastArrayList<WiresShape> prims, OffscreenCanvasRenderingContext2D ctx, WiresContainer skip, NFastStringMap<WiresShape> shape_color_map) {
        for (int j = 0; j < prims.size(); j++) {
            WiresShape prim = prims.get(j);
            if (prim == skip) {
                continue;
    ...
    //handrey
    public static void drawShapeToBacking(OffscreenCanvasRenderingContext2D ctx, WiresShape shape, String color, NFastStringMap<WiresShape> m_shape_color_map) {
        m_shape_color_map.put(color, shape);
        drawShapeToBacking(ctx, shape, color);
    }
    ...
    //handrey
    public static void drawShapeToBacking(OffscreenCanvasRenderingContext2D ctx, WiresShape shape, String color) {
        MultiPath multiPath = shape.getPath();
        drawShapeToBacking(ctx, shape, color, multiPath.getStrokeWidth(), true);
    }
    ...
    //handrey
    public static void drawShapeToBacking(OffscreenCanvasRenderingContext2D ctx, WiresShape shape, String color, double strokeWidth, boolean fill) {
        drawShapeToBacking(ctx, shape.getPath(), color, strokeWidth, fill);
    }
    ...
    //handrey
    public static void drawShapeToBacking(OffscreenCanvasRenderingContext2D ctx, MultiPath multiPath, String color, double strokeWidth, boolean fill) {
        NFastArrayList<PathPartList> listOfPaths = multiPath.getActualPathPartListArray();
